...
class TestUopsOptimization(unittest.TestCase):
    ...
    def test_call_isinstance_tuple_of_classes_unknown_length(self):
        def testfunc(n):
            x = 0
            for _ in range(n):
                # We know this is a tuple, but not the length
                classes = tuple([int, str])
                # This will only narrow to bool and not to True due to 'classes'
                # having unknown length
                y = isinstance(42, classes)
                if y:
                    x += 1
            return x
    ...
    def test_call_isinstance_tuple_of_classes_unknown_argument(self):
        def testfunc(n):
            class Foo:
                bar = 42
    ...
    def test_call_isinstance_tuple_of_classes_is_true_all_items_known(self):
        def testfunc(n):
            x = 0
            for _ in range(n):
                y = isinstance(42, (str, int))
                if y:
                    x += 1
            return x
    ...
    def test_call_isinstance_tuple_of_classes_is_true_unknown_items(self):
        def testfunc(n):
            class Type:
                str = str
    ...
    def test_call_isinstance_tuple_of_classes_is_false_unknown_items(self):
        def testfunc(n):
            class Type:
                str = str
